...
class DayMonthYearInputField extends StatefulWidget {
  ...
  DayMonthYearInputField({
    ...
    this.yearRange = const [1900, 2100],
        ...
        assert(yearRange.length == 2, 'La lista "yearRange" debe contener exactamente 2 años.'),
        assert(yearRange[0] <= yearRange[1], 'El primer año debe ser menor o igual al segundo año.');

  @override
  DayMonthYearInputFieldState createState() => DayMonthYearInputFieldState();
}


class DayMonthYearInputFieldState extends State<DayMonthYearInputField> {
